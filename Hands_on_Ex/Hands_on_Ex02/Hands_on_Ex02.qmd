---
title: "2 Spatial Weights and Application"
author: "Wan Kee"
...
<div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
  ...
  <div class="card-body">
    <h4 class="card-title">`spdep`</h4>
    <p class="card-text">A comprehensive package for spatial econometrics and spatial statistics. It provides functions and tools for handling spatial data, creating spatial weights matrices, and conducting spatial data analysis.</p>
  </div>
</div>

`spdep` is a comprehensive package for spatial econometrics and spatial statistics. It provides functions and tools for handling spatial data, creating spatial weights matrices, and conducting spatial data analysis.
