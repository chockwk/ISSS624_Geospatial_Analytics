...
```{r}
mpsz_pop<- left_join(mpsz, popdata2020,
                     by = c("SUBZONE_N" = "SZ"))
```
:::
...
Sembawang MRT (9 bus stops) ![](images/Screenshot%202023-11-26%20at%206.01.46%E2%80%AFPM.png){fig-align="left" width="700"}

Pasir Ris (11 bus stops) ![](images/Screenshot%202023-11-27%20at%202.20.59%E2%80%AFAM.png){fig-align="left" width="700"}
