...
# Use grid.arrange on the grobs
grid.arrange(
  weekday_morning_grob,
  weekday_afternoon_grob,
  weekend_morning_grob,
  weekend_evening_grob,
  ncol = 2,
  nrow = 2
)
...
weekend_evening_q_grob <- tmap_grob(weekend_evening_plot_q)
