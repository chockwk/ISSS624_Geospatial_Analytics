...
#weekday_morning_grob <- tmap_grob(weekday_morning_plot)
#weekday_afternoon_grob <- tmap_grob(weekday_afternoon_plot)
#weekend_morning_grob <- tmap_grob(weekend_morning_plot)
#weekend_evening_grob <- tmap_grob(weekend_evening_plot)

grid.arrange(weekday_morning_grob,weekday_afternoon_grob,
  weekend_morning_grob,weekend_evening_grob,
  ncol = 2,
  nrow = 2
)
```
...
#weekday_morning_q_grob <- tmap_grob(weekday_morning_plot_q)
#weekday_afternoon_q_grob <- tmap_grob(weekday_afternoon_plot_q)
#weekend_morning_q_grob <- tmap_grob(weekend_morning_plot_q)
#eekend_evening_q_grob <- tmap_grob(weekend_evening_plot_q)

grid.arrange(
  weekday_morning_q_grob,
  weekday_afternoon_q_grob,
  weekend_morning_q_grob,
  weekend_evening_q_grob,
  ncol = 2,
  nrow = 2
)
```
...
### Contiguity Weight Matrix `poly2nb` defines the spatial relationship between different regions by computing **contiguity weight matrices** and build a neighbours list based on regions with contiguous boundaries.
